...
<!--    <el-menu-item v-else index="5"><el-icon><User /></el-icon>登录</el-menu-item>-->
    <el-button class="el-menu-item" v-else text @click="dialogFormVisible = true">
  ...
  <login-or-register-dialog v-model="dialogFormVisible"/>
</template>
